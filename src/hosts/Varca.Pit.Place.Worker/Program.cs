...
if (string.IsNullOrEmpty(Environment.GetEnvironmentVariable("VARCA_PIT_PLACE_CONSUMER_ID"))) {
    if (args.Length == 0) {
        Environment.Exit(-2);
    }
}
...
builder.Services.AddHostedService<RedisPitPlaceWorker>();
